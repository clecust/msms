...
def _build_model(
    ...
    # ScaleShiftMSMACE
    if args.model == "ScaleShiftMSMACE":
        return modules.ScaleShiftMSMACE(
            **model_config,
            pair_repulsion=args.pair_repulsion,
            distance_transform=args.distance_transform,
            correlation=args.correlation,
    ...
    if args.model == "ScaleShiftMSMACECSOR":
        ...
        model_config["avg_num_neighbors"] = avg_num_neighbors
        logging.info(
            f"Using ScaleShiftMSMACECSOR, updata avg_num_neighbors to {model_config['avg_num_neighbors']}"
        )
        return modules.ScaleShiftMSMACECSOR(
            **model_config,
            pair_repulsion=args.pair_repulsion,
            distance_transform=args.distance_transform,
            correlation=args.correlation,
